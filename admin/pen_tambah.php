...
<form action="pen_prosestambah.php" method="post">
    <p>ID PENYAKIT: &nbsp;&nbsp;&nbsp;<input type="text" name="id_penyakit" class="read_more2" required="required"></p>
    <p>NAMA PENYAKIT: &nbsp;&nbsp;&nbsp;<input type="text" name="nama_penyakit" class="read_more2" required="required"></p>
    <p>N PENYAKIT: &nbsp;&nbsp;&nbsp;<input type="text" name="npenyakit" class="read_more2" value="0." required="required"></p>
