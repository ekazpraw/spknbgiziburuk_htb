...
<form action="pen_prosesedit.php" method="post">
    <?php
	$id = $_GET['id_penyakit'];
	$data = mysqli_query($con, "select * from daftar_penyakit where id_penyakit='$id'");
	while($d = mysqli_fetch_array($data)){
    ?>
    <p>ID PENYAKIT: &nbsp;&nbsp;&nbsp;<input type="text" name="id_penyakit" class="read_more2" value="<?php echo $d['id_penyakit']; ?>" readonly></p>
    <p>NAMA PENYAKIT: &nbsp;&nbsp;&nbsp;<input type="text" name="nama_penyakit" class="read_more2" value="<?php echo $d['nama_penyakit']; ?>" required="required"></p>
    <p>N PENYAKIT: &nbsp;&nbsp;&nbsp;<input type="text" name="npenyakit" class="read_more2" value="<?php echo $d['npenyakit']; ?>" required="required"></p>
