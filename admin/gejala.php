...
<div class="top_left_cont zoomIn wow animated">
    <h2>Daftar Gejala:</h2>
    <div align="right"><a href="g_tambah.php" class="read_more2">TAMBAH DATA</a></div>
    <br>
		<?php
        $sql = 'SELECT * FROM daftar_gejala';
        ...
        echo '<tr>
			...
			<td>'.$row['gejala'].'</td>
			<td>
            <a href="g_hapus.php?id_gejala='.$row['id_gejala'].'">Hapus</a> | 
            <a href="g_edit.php?id_gejala='.$row['id_gejala'].'">Edit</a>
            </td>
		</tr>';
        }
        echo '
