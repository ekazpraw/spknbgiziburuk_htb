...
<div class="top_left_cont zoomIn wow animated">
    <h2>Daftar Gejala:</h2>
<form action="g_prosestambah.php" method="post">
    <p>ID GEJALA: &nbsp;&nbsp;&nbsp;<input type="text" name="id_gejala" class="read_more2" required="required"></p>
    <p>NAMA GEJALA: &nbsp;&nbsp;&nbsp;<input type="text" name="gejala" class="read_more2" required="required"></p>
