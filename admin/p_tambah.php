...
<?php
	$query = mysqli_query($con, "SELECT max(id_pengguna) as kodeTerbesar FROM pengguna");
	$data = mysqli_fetch_array($query);
	$kodeTambah = $data['kodeTerbesar'];
	$urutan = (int) ($kodeTambah);
	$urutan++;
	$kodeTambah = $urutan++;
?>
...
<form action="p_prosestambah.php" method="post">
    <p>ID PENGGUNA: &nbsp;&nbsp;&nbsp;<input type="text" name="id_pengguna" class="read_more2" value="<?php echo $kodeTambah ?>" readonly></p>
    <p>NAMA PENGGUNA: &nbsp;&nbsp;&nbsp;<input type="text" name="nama_pengguna" class="read_more2" required="required"></p>
    <p>USERNAME: &nbsp;&nbsp;&nbsp;<input type="text" name="username" class="read_more2" required="required"></p>
    <p>PASSWORD: &nbsp;&nbsp;&nbsp;<input type="password" name="password" class="read_more2" required="required"></p>
    <p>LEVEL: &nbsp;&nbsp;&nbsp;
