...
<div class="top_left_cont zoomIn wow animated">
    <h2>Daftar Gejala:</h2>
<form action="g_prosesedit.php" method="post">
    <?php
	$id = $_GET['id_gejala'];
	$data = mysqli_query($con, "select * from daftar_gejala where id_gejala='$id'");
	while($d = mysqli_fetch_array($data)){
    ?>
    <p>ID GEJALA: &nbsp;&nbsp;&nbsp;<input type="text" name="id_gejala" class="read_more2" value="<?php echo $d['id_gejala']; ?>" readonly></p>
    <p>NAMA GEJALA: &nbsp;&nbsp;&nbsp;<input type="text" name="gejala" class="read_more2" value="<?php echo $d['gejala']; ?>" required="required"></p>
