...
<div class="top_left_cont zoomIn wow animated">
    ...
    <div align="right"><a href="p_tambah.php" class="read_more2">TAMBAH DATA</a></div>
    <br>
		<?php
        ...
        echo '<tr>
			...
			<td>'.$row['level'].'</td>
			<td>
            <a href="p_hapus.php?id_pengguna='.$row['id_pengguna'].'">Hapus</a> | 
            <a href="p_edit.php?id_pengguna='.$row['id_pengguna'].'">Edit</a>
            </td>
		</tr>';
        }
        echo '
