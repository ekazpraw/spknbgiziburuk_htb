...
<div class="top_left_cont zoomIn wow animated">
    ...
    <div align="right"><a href="b_tambah.php" class="read_more2">TAMBAH DATA</a></div>
    <br>
		<?php
        $sql = 'SELECT * FROM basis_aturan';
		...
		<thead>
			<tr>
				...
				<th>FAKTA (IYA)</th>
				<th>FAKTA (TIDAK)</th>
				<th>GEJALA 1 (KWARSHIORKOR)</th>
				<th>GEJALA 2 (MARASMIK-KWARSHIORKOR)</th>
				<th>GEJALA 3 (MARASMUS)</th>
				<th>AKSI</th>
			</tr>
		</thead>
		<tbody>';
        ...
        echo '<tr>
			...
			<td>'.$row['fakta_ya'].'</td>
			<td>'.$row['fakta_tidak'].'</td>
			<td>'.$row['kwarshiorkor'].'</td>
			<td>'.$row['marasmik-kwarshiorkor'].'</td>
			<td>'.$row['marasmus'].'</td>
			<td>
            <a href="b_hapus.php?id_basisaturan='.$row['id_gejala'].'">Hapus</a>
            </td>
		</tr>';
        }
        echo '
